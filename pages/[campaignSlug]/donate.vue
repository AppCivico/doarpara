<template>
  <div class="page-wrapper page-wrapper--donate container">
    <h1>{{ campaign?.name }}</h1>
      ...
      <fieldset class="flexible-fieldset">
        ...
        <ul class="list-of-options" data-field-size="100">
          <li class="list-of-options__item">
            ...
            />
            <MDC
              :value="$t('donationForm.naturalPersonIdentificationAgreement')"
              tag="label"
              unwrap="p"
              for="natural-person-identification-agreement"
            />
          </li>
        </ul>
